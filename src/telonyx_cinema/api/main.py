...
def download_youtube_video(job_id: str, url: str, output_dir: Path) -> Path:
    ...
    if result.returncode != 0:
        raise RuntimeError(f"yt-dlp failed: {result.stdout[-1000:]}")
