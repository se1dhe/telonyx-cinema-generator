...
APP_VERSION = "dialogue-shorts-v8-refined-telonyx-title-2026-05-18"
...
def write_title_ass(path: Path, movie_title: str, movie_year: str, duration: float) -> None:
    # Фирменный титр TELONYX CINEMA без дешёвых плашек.
    # Айдентика строится на типографике, маленьком TX-маркере, тонкой cyan-линии и постоянном watermark.
    # Цвета ASS указаны в BGR-формате: cyan RGB(34,211,238) = &H00EED322.
    ...
    cyan = "&H00EED322"
    cyan_soft = "&H78EED322"
    rule_shape = r"{\p1}m 0 0 l 122 0 l 122 2 l 0 2{\p0}"
...
Style: TxMark,DejaVu Sans,19,{cyan},&H000000FF,&H8A000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.55,0.2,1,0,0,0,1
Style: Brand,DejaVu Sans,17,&HA8FFFFFF,&H000000FF,&H76000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.35,0.12,1,0,0,0,1
Style: MovieTitle,DejaVu Sans,43,&H00F4F0E7,&H000000FF,&HB4000000,&H00000000,-1,0,0,0,100,100,0,0,1,1.1,0.42,1,0,0,0,1
Style: MovieYear,DejaVu Sans,22,&H9CFFFFFF,&H000000FF,&H8A000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.45,0.16,1,0,0,0,1
Style: Rule,DejaVu Sans,16,{cyan_soft},&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,0,0,7,0,0,0,1
Style: Mark,DejaVu Sans,22,&H72FFFFFF,&H000000FF,&H66000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.8,0.4,5,0,0,0,1

[Events]
Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
Dialogue: 2,{ass_time(0.00)},{ass_time(outro_start)},TxMark,,0,0,0,,{{\\move({hidden_x},{y_brand},{x},{y_brand},0,{enter_end_ms})\\fsp1.2\\fad(120,0)}}TX
Dialogue: 2,{ass_time(0.03)},{ass_time(outro_start)},Brand,,0,0,0,,{{\\move({hidden_x + 43},{y_brand},{x + 43},{y_brand},0,{enter_end_ms})\\fsp4.0\\fad(120,0)}}TELONYX CINEMA
Dialogue: 3,{ass_time(0.05)},{ass_time(outro_start)},MovieTitle,,0,0,0,,{{\\move({hidden_x},{y_title},{x},{y_title},0,{enter_end_ms})\\fsp0.85\\blur0.14\\fad(120,0)}}{title}
Dialogue: 2,{ass_time(0.08)},{ass_time(outro_start)},MovieYear,,0,0,0,,{{\\move({hidden_x},{y_year},{x},{y_year},0,{enter_end_ms})\\fsp4.4\\blur0.08\\fad(120,0)}}{year}
Dialogue: 1,{ass_time(0.11)},{ass_time(outro_start)},Rule,,0,0,0,,{{\\move({hidden_x},{y_rule},{x},{y_rule},0,{enter_end_ms})\\fad(120,0)}}{rule_shape}

Dialogue: 2,{ass_time(outro_start)},{ass_time(duration)},TxMark,,0,0,0,,{{\\move({x},{y_brand},{hidden_x},{y_brand},0,{outro_move_end_ms})\\fsp1.2\\fad(0,190)}}TX
Dialogue: 2,{ass_time(outro_start)},{ass_time(duration)},Brand,,0,0,0,,{{\\move({x + 43},{y_brand},{hidden_x + 43},{y_brand},0,{outro_move_end_ms})\\fsp4.0\\fad(0,190)}}TELONYX CINEMA
Dialogue: 3,{ass_time(outro_start)},{ass_time(duration)},MovieTitle,,0,0,0,,{{\\move({x},{y_title},{hidden_x},{y_title},0,{outro_move_end_ms})\\fsp0.85\\blur0.14\\fad(0,190)}}{title}
Dialogue: 2,{ass_time(outro_start)},{ass_time(duration)},MovieYear,,0,0,0,,{{\\move({x},{y_year},{hidden_x},{y_year},0,{outro_move_end_ms})\\fsp4.4\\blur0.08\\fad(0,190)}}{year}
Dialogue: 1,{ass_time(outro_start)},{ass_time(duration)},Rule,,0,0,0,,{{\\move({x},{y_rule},{hidden_x},{y_rule},0,{outro_move_end_ms})\\fad(0,190)}}{rule_shape}

Dialogue: 5,{ass_time(0.25)},{ass_time(max(0.3, duration - 0.18))},Mark,,0,0,0,,{{\\pos(1032,960)\\frz90\\fsp5\\alpha&H62&\\fad(420,420)}}TELONYX
"""
