...
APP_VERSION = "dialogue-shorts-v15-accurate-subs-2026-05-19"
...
def transcribe(job_id: str, input_path: Path, language: str) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    if not ENABLE_WHISPER:
        raise RuntimeError("Автосубтитры включены в вебморде, но ENABLE_WHISPER=false на сервере")
    try:
    ...
    kwargs: dict[str, Any] = {
        ...
        "vad_parameters": {"threshold": 0.45, "min_silence_duration_ms": 420, "speech_pad_ms": 240},
    }
    if selected != "auto":
