...
APP_VERSION = "dialogue-shorts-v17-ui-restored-vad-fixed-2026-05-19"
...
def render_video(job_id: str) -> None:
    ...
    try:
        ...
        run_cmd(job_id, [FFMPEG, "-y", "-i", str(input_path), "-vf", video_filter(title_ass, subs_file), "-map", "0:v:0", "-map", "0:a?", "-c:v", "libx264", "-preset", "veryfast", "-crf", "20", "-c:a", "aac", "-b:a", "192k", "-movflags", "+faststart", "-pix_fmt", "yuv420p", "-shortest", str(output_path)])
