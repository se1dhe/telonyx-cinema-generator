...
APP_VERSION = "dialogue-shorts-v9-txc-ukraine-title-2026-05-18"
...
def write_title_ass(path: Path, movie_title: str, movie_year: str, duration: float) -> None:
    # Фирменный титр TXC Ukraine:
    # компактный бренд, сильное название фильма, выделенный год и тонкая вертикальная cyan-ось.
    # Без длинного TELONYX CINEMA в кадре: TXC лучше читается в Shorts/TikTok и работает как аватарочный бренд.
    ...
    cyan = "&H00EED322"
    cyan_soft = "&H66EED322"
    axis_shape = r"{\p1}m 0 0 l 4 0 l 4 106 l 0 106{\p0}"
    year_rule_shape = r"{\p1}m 0 0 l 40 0 l 40 2 l 0 2{\p0}"
...
Style: Brand,DejaVu Sans,18,&H9CFFFFFF,&H000000FF,&H7A000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.35,0.12,1,0,0,0,1
Style: MovieTitle,DejaVu Sans,54,&H00F6F2EA,&H000000FF,&HB8000000,&H00000000,-1,0,0,0,100,100,0,0,1,1.35,0.55,1,0,0,0,1
Style: MovieYear,DejaVu Sans,28,{cyan},&H000000FF,&HA0000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.7,0.22,1,0,0,0,1
...
Dialogue: 1,{ass_time(0.00)},{ass_time(outro_start)},Axis,,0,0,0,,{{\\move({hidden_bar_x},{y_bar},{bar_x},{y_bar},0,{enter_end_ms})\\fad(120,0)}}{axis_shape}
Dialogue: 2,{ass_time(0.02)},{ass_time(outro_start)},Brand,,0,0,0,,{{\\move({hidden_text_x},{y_brand},{text_x},{y_brand},0,{enter_end_ms})\\fsp3.0\\fad(120,0)}}TXC UKRAINE
Dialogue: 3,{ass_time(0.05)},{ass_time(outro_start)},MovieTitle,,0,0,0,,{{\\move({hidden_text_x},{y_title},{text_x},{y_title},0,{enter_end_ms})\\fsp0.65\\blur0.12\\fad(120,0)}}{title}
Dialogue: 3,{ass_time(0.08)},{ass_time(outro_start)},MovieYear,,0,0,0,,{{\\move({hidden_text_x},{y_year},{text_x},{y_year},0,{enter_end_ms})\\fsp3.4\\blur0.08\\fad(120,0)}}{year}
Dialogue: 1,{ass_time(0.10)},{ass_time(outro_start)},Rule,,0,0,0,,{{\\move({hidden_text_x + 92},{y_year + 18},{text_x + 92},{y_year + 18},0,{enter_end_ms})\\fad(120,0)}}{year_rule_shape}

Dialogue: 1,{ass_time(outro_start)},{ass_time(duration)},Axis,,0,0,0,,{{\\move({bar_x},{y_bar},{hidden_bar_x},{y_bar},0,{outro_move_end_ms})\\fad(0,190)}}{axis_shape}
Dialogue: 2,{ass_time(outro_start)},{ass_time(duration)},Brand,,0,0,0,,{{\\move({text_x},{y_brand},{hidden_text_x},{y_brand},0,{outro_move_end_ms})\\fsp3.0\\fad(0,190)}}TXC UKRAINE
Dialogue: 3,{ass_time(outro_start)},{ass_time(duration)},MovieTitle,,0,0,0,,{{\\move({text_x},{y_title},{hidden_text_x},{y_title},0,{outro_move_end_ms})\\fsp0.65\\blur0.12\\fad(0,190)}}{title}
Dialogue: 3,{ass_time(outro_start)},{ass_time(duration)},MovieYear,,0,0,0,,{{\\move({text_x},{y_year},{hidden_text_x},{y_year},0,{outro_move_end_ms})\\fsp3.4\\blur0.08\\fad(0,190)}}{year}
Dialogue: 1,{ass_time(outro_start)},{ass_time(duration)},Rule,,0,0,0,,{{\\move({text_x + 92},{y_year + 18},{hidden_text_x + 92},{y_year + 18},0,{outro_move_end_ms})\\fad(0,190)}}{year_rule_shape}

Dialogue: 5,{ass_time(0.25)},{ass_time(max(0.3, duration - 0.18))},Mark,,0,0,0,,{{\\pos(1032,960)\\frz90\\fsp5\\alpha&H62&\\fad(420,420)}}TXC
"""
...
def render_video(job_id: str) -> None:
    ...
    try:
        ...
        write_state(job_id, {"progress": 22, "duration": duration, "message": "Готовлю фирменный TXC Ukraine титр"})
