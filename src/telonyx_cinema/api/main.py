...
APP_VERSION = "dialogue-shorts-v10-locked-txc-title-block-2026-05-18"
...
def write_title_ass(path: Path, movie_title: str, movie_year: str, duration: float) -> None:
    ...
    # Раньше бренд, название, год и линия были разными слоями, поэтому композиция визуально съезжала.
    # Теперь TXC UKRAINE + название + год движутся как единый объект.
...
def render_video(job_id: str) -> None:
    ...
    try:
        ...
        write_state(job_id, {"progress": 22, "duration": duration, "message": "Готовлю зафиксированный TXC Ukraine титр"})
