...
def render_tiktok_video(job_id: str) -> None:
    ...
    try:
        ...
        write_tiktok_state(job_id, {
            ...
            "youtube_meta_title": yt_meta.get("title", "") if youtube_url else "",
        })
    except Exception as exc:
        log(job_id, f"FAILED: {exc}")
