...
APP_VERSION = "dialogue-shorts-v7-telonyx-cinema-identity-2026-05-18"
...
def write_title_ass(path: Path, movie_title: str, movie_year: str, duration: float) -> None:
    # TELONYX Cinema identity:
    # не просто название фильма, а фирменный channel label для Shorts/TikTok.
    # Структура: TELONYX CINEMA -> название фильма -> год в маленьком бейдже.
    # Всё висит весь ролик, выкатывается в начале и уходит под конец.
    ...
    y_year = 1605
    y_tag = 1642
    tag_shape = r"{\p1}m 0 0 l 166 0 l 166 32 l 0 32{\p0}"
    hairline = r"{\p1}m 0 0 l 56 0 l 56 2 l 0 2{\p0}"
...
Style: Brand,DejaVu Sans,18,&H8CFFFFFF,&H000000FF,&H76000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.35,0.12,1,0,0,0,1
Style: MovieTitle,DejaVu Sans,43,&H00F4F0E7,&H000000FF,&HB4000000,&H00000000,-1,0,0,0,100,100,0,0,1,1.15,0.42,1,0,0,0,1
Style: YearTag,DejaVu Sans,21,&H0022D3EE,&H000000FF,&H86000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.45,0.16,1,0,0,0,1
Style: Shape,DejaVu Sans,16,&H3622D3EE,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,0,0,7,0,0,0,1
Style: Hair,DejaVu Sans,16,&H7022D3EE,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,0,0,7,0,0,0,1
Style: Mark,DejaVu Sans,22,&H72FFFFFF,&H000000FF,&H66000000,&H00000000,-1,0,0,0,100,100,0,0,1,0.8,0.4,5,0,0,0,1

[Events]
Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
Dialogue: 1,{ass_time(0.00)},{ass_time(outro_start)},Brand,,0,0,0,,{{\\move({hidden_x},{y_brand},{x},{y_brand},0,{enter_end_ms})\\fsp4.5\\fad(120,0)}}TELONYX CINEMA
Dialogue: 3,{ass_time(0.04)},{ass_time(outro_start)},MovieTitle,,0,0,0,,{{\\move({hidden_x},{y_title},{x},{y_title},0,{enter_end_ms})\\fsp1.0\\blur0.16\\fad(120,0)}}{title}
Dialogue: 0,{ass_time(0.07)},{ass_time(outro_start)},Shape,,0,0,0,,{{\\move({hidden_x},{y_year - 22},{x},{y_year - 22},0,{enter_end_ms})\\fad(120,0)}}{tag_shape}
Dialogue: 2,{ass_time(0.08)},{ass_time(outro_start)},YearTag,,0,0,0,,{{\\move({hidden_x + 18},{y_year - 15},{x + 18},{y_year - 15},0,{enter_end_ms})\\fsp3.8\\fad(120,0)}}{year}
Dialogue: 1,{ass_time(0.11)},{ass_time(outro_start)},Hair,,0,0,0,,{{\\move({hidden_x + 1},{y_tag},{x + 1},{y_tag},0,{enter_end_ms})\\fad(120,0)}}{hairline}

Dialogue: 1,{ass_time(outro_start)},{ass_time(duration)},Brand,,0,0,0,,{{\\move({x},{y_brand},{hidden_x},{y_brand},0,{outro_move_end_ms})\\fsp4.5\\fad(0,190)}}TELONYX CINEMA
Dialogue: 3,{ass_time(outro_start)},{ass_time(duration)},MovieTitle,,0,0,0,,{{\\move({x},{y_title},{hidden_x},{y_title},0,{outro_move_end_ms})\\fsp1.0\\blur0.16\\fad(0,190)}}{title}
Dialogue: 0,{ass_time(outro_start)},{ass_time(duration)},Shape,,0,0,0,,{{\\move({x},{y_year - 22},{hidden_x},{y_year - 22},0,{outro_move_end_ms})\\fad(0,190)}}{tag_shape}
Dialogue: 2,{ass_time(outro_start)},{ass_time(duration)},YearTag,,0,0,0,,{{\\move({x + 18},{y_year - 15},{hidden_x + 18},{y_year - 15},0,{outro_move_end_ms})\\fsp3.8\\fad(0,190)}}{year}
Dialogue: 1,{ass_time(outro_start)},{ass_time(duration)},Hair,,0,0,0,,{{\\move({x + 1},{y_tag},{hidden_x + 1},{y_tag},0,{outro_move_end_ms})\\fad(0,190)}}{hairline}

Dialogue: 5,{ass_time(0.25)},{ass_time(max(0.3, duration - 0.18))},Mark,,0,0,0,,{{\\pos(1032,960)\\frz90\\fsp5\\alpha&H5C&\\fad(420,420)}}TELONYX
"""
...
def render_video(job_id: str) -> None:
    ...
    try:
        ...
        write_state(job_id, {"progress": 22, "duration": duration, "message": "Готовлю фирменный TELONYX Cinema титр"})
